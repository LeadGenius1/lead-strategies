      ...
      <footer className="border-t border-white/5 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">AI LEAD STRATEGIES LLC</span>
          </div>
          <div className="flex gap-6 text-neutral-500 text-sm">
            <Link href="/privacy" className="hover:text-white transition">Privacy</Link>
            <Link href="/terms" className="hover:text-white transition">Terms</Link>
            <span>hello@aileadstrategies.com</span>
            <span>Wyomissing, PA 19610</span>
          </div>
          <p className="text-neutral-600 text-sm">© 2026 AI Lead Strategies LLC</p>
        </div>
      </footer>
    </div>
  )
