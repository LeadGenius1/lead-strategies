...
const TIERS = [
  { id: 'leadsite-ai', name: 'LeadSite.AI', price: '$39/mo', description: 'AI email lead generation' },
  { id: 'leadsite-io', name: 'LeadSite.IO', price: '$39/mo', description: '+ 1 Free AI Website', highlight: true },
  { id: 'clientcontact', name: 'ClientContact.IO', price: '$99/mo', description: '22+ channel unified inbox' },
  { id: 'tackle', name: 'TackleAI', price: '$149/mo', description: 'Full CRM + Voice + 7 AI Agents' },
  { id: 'videosite', name: 'VideoSite.AI', price: 'FREE', description: 'Create videos, earn $1/view', free: true },
]
