  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white antialiased selection:bg-indigo-500/30 p-6 md:p-8">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <Link href="/nexus/setup" className="block group mb-4">
          <div className="relative rounded-xl bg-neutral-900/30 border border-white/[0.06] p-5 overflow-hidden hover:border-emerald-500/30 transition-all">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white">Business Profile Setup</h3>
                  <p className="text-xs text-neutral-500">Set up once, AI handles the rest — 3-step guided onboarding</p>
                </div>
              </div>
