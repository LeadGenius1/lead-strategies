...
export async function GET(
  ...
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        { success: false, error: data.message || data.error || 'Failed to fetch lead' },
...
export async function PUT(
  ...
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        { success: false, error: data.message || data.error || 'Failed to update lead' },
        { status: response.status }
      );
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (!response.ok) {
      const data = await response.json();
      return NextResponse.json(
        { success: false, error: data.message || data.error || 'Failed to delete lead' },
        { status: response.status }
      );
    }
