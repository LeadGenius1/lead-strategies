...
export const metadata = {
  title: 'CCPA | AI Lead Strategies',
  description: 'California Consumer Privacy Act disclosure for AI Lead Strategies.',
};
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-medium tracking-tight text-white mb-6">CCPA</h1>
        <p className="text-neutral-400 text-sm leading-relaxed mb-6">
          California Consumer Privacy Act disclosure and rights. Content to be added.
        </p>
