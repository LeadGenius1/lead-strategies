      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 pt-32 pb-16 md:pt-52 md:pb-32">
          <div className="container mx-auto px-4 relative max-w-7xl">
            <div className="flex flex-col text-center mb-16 relative space-y-0 items-center justify-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-300 text-[10px] md:text-xs font-medium tracking-wide mb-6 [animation:animationIn_0.8s_ease-out_0.15s_both] animate-on-scroll">
              ...
              <div className="flex flex-col z-10 w-full items-center justify-center">
                <h1 className="leading-[0.95] flex flex-wrap justify-center gap-x-3 md:gap-x-4 text-5xl sm:text-6xl md:text-7xl font-semibold text-white tracking-tighter mt-2 mb-0 font-space-grotesk">
                  Find Your Perfect Clients with <span className="text-gradient font-light">AI Intelligence</span>
                </h1>
              </div>

              <p className="[animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll text-base text-neutral-300 tracking-tight font-geist md:text-xl mt-6 max-w-3xl">
              ...
              <div className="flex flex-col md:flex-row gap-4 mt-10 [animation:animationIn_0.8s_ease-out_0.6s_both] animate-on-scroll">
                ...
                <Link href="#features" className="bg-transparent border border-subtle text-white px-10 py-4 text-sm font-bold tracking-widest uppercase hover:bg-white/5 transition-colors font-geist">
                  Explore Features
                </Link>
              </div>

              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto counter-trigger [animation:animationIn_0.8s_ease-out_0.5s_both] animate-on-scroll mt-12">
                <div className="bg-[#050505] border border-subtle p-6">
                  <div className="text-2xl md:text-3xl text-white mb-1 tracking-tighter font-space-grotesk font-light">
                    <span data-target="8" data-suffix="+">8+</span>
                  </div>
                  <h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Data Sources</h3>
                </div>
                <div className="bg-[#050505] border border-subtle p-6">
                  <div className="text-2xl md:text-3xl text-white mb-1 tracking-tighter font-space-grotesk font-light">
                ...
                <div className="bg-[#050505] border border-subtle p-6">
                  <div className="text-2xl md:text-3xl text-white mb-1 tracking-tighter font-space-grotesk font-light">GDPR</div>
                  <h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Compliant</h3>
                </div>
                <div className="bg-[#050505] border border-subtle p-6">
                  <div className="text-2xl md:text-3xl text-white mb-1 tracking-tighter font-space-grotesk font-light">Real-time</div>
                  <h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Enrichment</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
            ...
            <div className="flex gap-8 text-xs font-geist text-neutral-500 uppercase tracking-widest">
              ...
              <Link href="/support" className="hover:text-white transition-colors">Compliance</Link>
            </div>
          </div>
          ...
          <div className="border-t border-subtle pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-widest text-neutral-600">
            <p className="font-geist">© 2026 AI Lead Strategies LLC. All rights reserved.</p>
            <div className="flex gap-6 mt-4 md:mt-0">
              <a href="tel:8008833051" className="hover:text-white transition-colors font-geist">800.883.3051</a>
              <a href="mailto:aileadstrategies@gmail.com" className="hover:text-white transition-colors font-geist">aileadstrategies@gmail.com</a>
            </div>
          </div>
        </div>
      </footer>
