...
export const metadata = {
  title: 'Cookie Policy | AI Lead Strategies',
  description: 'Cookie Policy for AI Lead Strategies.',
};
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-medium tracking-tight text-white mb-6">Cookie Policy</h1>
        <p className="text-neutral-400 text-sm leading-relaxed mb-6">
          How we use cookies and similar technologies. Content to be added.
        </p>
