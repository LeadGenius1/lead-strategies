...
export const metadata = {
  title: 'GDPR | AI Lead Strategies',
  description: 'GDPR and EU data protection information for AI Lead Strategies.',
};
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-medium tracking-tight text-white mb-6">GDPR</h1>
        <p className="text-neutral-400 text-sm leading-relaxed mb-6">
          EU General Data Protection Regulation and your rights. Content to be added.
        </p>
