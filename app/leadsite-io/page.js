      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative max-w-7xl">
          <div className="flex flex-col text-center mb-24 relative space-y-0 items-center justify-center">
            ...
            <h2 className="[animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll text-lg text-neutral-400 tracking-tight font-space-grotesk md:text-3xl mt-8 mb-4">
            ...
            <p className="[animation:animationIn_0.8s_ease-out_0.45s_both] animate-on-scroll text-base text-purple-300 tracking-tight font-space-grotesk md:text-xl mb-6">
              Includes an AI website builder — launch your first lead-generating website free.
            </p>

            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-300 text-[10px] md:text-xs font-medium tracking-wide mb-8 [animation:animationIn_0.8s_ease-out_0.5s_both] animate-on-scroll mt-6">
            ...
            {/* CTAs */}
            <div className="flex flex-col md:flex-row gap-4 mt-8 [animation:animationIn_0.8s_ease-out_0.6s_both] animate-on-scroll">
