...
export const metadata = {
  title: 'Privacy Policy | AI Lead Strategies',
  description: 'Privacy Policy for AI Lead Strategies.',
};
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-medium tracking-tight text-white mb-6">Privacy Policy</h1>
        <p className="text-neutral-400 text-sm leading-relaxed mb-6">
          This page will contain the full Privacy Policy. Content to be added.
        </p>
