...
export const metadata = {
  title: 'Security | AI Lead Strategies',
  description: 'Security practices and information for AI Lead Strategies.',
};
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-medium tracking-tight text-white mb-6">Security</h1>
        <p className="text-neutral-400 text-sm leading-relaxed mb-6">
          This page will contain security practices, compliance, and incident reporting. Content to be added.
        </p>
