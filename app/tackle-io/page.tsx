    ...
    <div className="relative overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-purple-950/20 to-[#050505] border border-purple-500/30 p-8 relative overflow-hidden [animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll">
              ...
              <h3 className="text-2xl font-space-grotesk text-white mb-6">Tackle.IO</h3>
              <div className="space-y-4 mb-6">
      ...
      <section className="py-24 relative z-10 border-t border-subtle bg-gradient-to-b from-black to-purple-950/5">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              { step: '01', title: 'Import Existing Data', desc: 'Migrate from HubSpot/Salesforce in 24 hours' },
              { step: '02', title: 'Connect All Channels', desc: 'OAuth for LinkedIn, FB, IG, Twitter, etc.' },
              { step: '03', title: 'AI Agents Activate', desc: 'Self-configure based on your industry, ICP' },
              { step: '04', title: 'Scale Revenue', desc: '7 agents working 24/7, you focus on closing' }
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section className="py-24 relative z-10 border-t border-subtle">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            ...
            <p className="text-neutral-400 font-geist">Automated sequences across 22 platforms</p>
          </div>

          <div className="bg-[#050505] border border-purple-500/20 p-8 md:p-12 max-w-5xl mx-auto [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
            <div className="space-y-6">
              {[
                { day: 'Day 1', platform: 'LinkedIn', action: 'Connection Request' },
                { day: 'Day 3', platform: 'Email', action: 'Introduction' },
                { day: 'Day 5', platform: 'Twitter', action: 'Mention' },
                { day: 'Day 7', platform: 'Phone', action: 'Call' },
                { day: 'Day 10', platform: 'WhatsApp', action: 'Follow-up' },
                { day: 'Day 14', platform: 'Video', action: 'Personalized Message' }
              ].map((item, index) => (
                <div key={index} className="flex items-center gap-6 border-b border-subtle pb-6 last:border-0 last:pb-0">
                  <div className="w-20 text-purple-400 font-space-grotesk text-sm">{item.day}</div>
                  <div className="flex-1">
                    <div className="text-white font-space-grotesk mb-1">{item.platform}</div>
                    <div className="text-neutral-400 font-geist text-sm">{item.action}</div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-[#050505] border border-subtle p-8 [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
              ...
              <div className="text-4xl font-space-grotesk font-light text-white mb-6">
                $599<span className="text-sm text-neutral-500">/mo</span>
              </div>
      ...
      <section className="py-24 relative z-10 border-t border-subtle bg-gradient-to-b from-black to-purple-950/5">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            ...
            <p className="text-neutral-400 font-geist mb-8">Enterprise-grade security. Your data never trains our AI models.</p>
          </div>

          <div className="flex flex-wrap justify-center gap-4 [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
            {['SOC 2 Type II', 'GDPR', 'CCPA', 'ISO 27001', 'HIPAA'].map((badge, index) => (
              <div
                key={index}
                className="px-6 py-3 bg-[#050505] border border-purple-500/20 text-white font-geist text-sm uppercase tracking-wider"
              >
                {badge}
              </div>
            ))}
      ...
      <section className="py-24 relative z-10 border-t border-subtle">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            <h2 className="text-5xl md:text-7xl uppercase mb-4 text-white tracking-tighter font-space-grotesk font-light">
              See Tackle.IO <span className="text-gradient">in Action</span>
            </h2>
            <p className="text-neutral-400 font-geist">5-minute overview of the enterprise platform</p>
          </div>

          <div className="relative aspect-video bg-[#050505] border border-purple-500/20 [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
            ...
            <div className="absolute bottom-4 left-4 text-sm text-neutral-400 font-geist">
              Watch how Fortune 500 teams replace 5 tools with Tackle.IO
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative z-10 border-t border-subtle bg-gradient-to-b from-black to-purple-950/5">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-[#050505] border border-purple-500/20 p-8 md:p-12 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            <div className="text-purple-400 text-xs uppercase tracking-widest font-geist mb-4">CASE STUDY</div>
            <h2 className="text-3xl md:text-5xl font-space-grotesk text-white mb-6">
              How TechCorp Replaced 5 Tools with Tackle.IO and Saved $62K/Year
            </h2>
            <blockquote className="text-xl text-neutral-300 font-geist mb-6 italic">
              "Tackle.IO transformed our sales operations. We eliminated 5 separate tools, reduced costs by 85%, and increased pipeline velocity by 3x."
            </blockquote>
            <div className="text-sm text-neutral-400 font-geist mb-2">— CEO, TechCorp</div>
            <div className="grid grid-cols-3 gap-6 mt-8 pt-8 border-t border-subtle">
              <div>
                <div className="text-3xl text-purple-400 font-space-grotesk font-light mb-1">3x</div>
                <div className="text-xs text-neutral-500 font-geist uppercase">Pipeline Growth</div>
              </div>
              <div>
                <div className="text-3xl text-purple-400 font-space-grotesk font-light mb-1">40%</div>
                <div className="text-xs text-neutral-500 font-geist uppercase">Faster Close</div>
              </div>
              <div>
                <div className="text-3xl text-purple-400 font-space-grotesk font-light mb-1">94%</div>
                <div className="text-xs text-neutral-500 font-geist uppercase">Team Adoption</div>
              </div>
            </div>
            <Link href="#" className="inline-block mt-8 text-purple-400 hover:text-purple-300 font-geist text-sm uppercase tracking-widest">
      ...
      <section className="py-24 relative z-10 border-t border-subtle">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-6 [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
            {['Salesforce', 'HubSpot', 'Slack', 'Teams', 'Zoom', 'Calendly', 'DocuSign', 'Stripe', 'QuickBooks'].map((name, index) => (
              <div
                key={index}
      ...
      <section className="py-24 relative z-10 border-t border-subtle bg-gradient-to-b from-black to-purple-950/5">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            ...
            <p className="text-neutral-400 font-geist">Tackle.IO works seamlessly with all our platforms</p>
          </div>
