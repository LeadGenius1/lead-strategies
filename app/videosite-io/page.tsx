    ...
    <div className="relative overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 relative max-w-7xl">
          <div className="flex flex-col text-center mb-24 relative space-y-0 items-center justify-center">
            ...
            <h2 className="[animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll text-lg text-neutral-400 tracking-tight font-space-grotesk md:text-3xl mt-8 mb-6">
              AI-powered video marketing. 4K Hollywood quality. 10x engagement.
            </h2>
      ...
      <section className="py-24 relative z-10 border-t border-subtle bg-gradient-to-b from-black to-purple-950/5">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-12 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            <h2 className="text-5xl md:text-7xl uppercase mb-4 text-white tracking-tighter font-space-grotesk font-light">
              One Video, <span className="text-gradient">Four Platforms</span>
            </h2>
            <p className="text-neutral-400 font-geist">Zero Manual Work</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
            {[
              { platform: 'YouTube', format: '16:9 landscape', duration: '5-min version' },
              { platform: 'Instagram', format: '1:1 square', duration: '60-second version' },
              { platform: 'TikTok', format: '9:16 vertical', duration: '30-second version' },
              { platform: 'LinkedIn', format: '16:9 landscape', duration: '2-min with captions' }
            ].map((item, index) => (
              <div key={index} className="bg-[#050505] border border-purple-500/20 p-6">
                <div className="text-2xl mb-3">{item.platform === 'YouTube' ? '📺' : item.platform === 'Instagram' ? '📷' : item.platform === 'TikTok' ? '🎵' : '💼'}</div>
                <h3 className="text-lg font-space-grotesk text-white mb-2">{item.platform}</h3>
                <p className="text-sm text-neutral-400 font-geist mb-1">{item.format}</p>
                <p className="text-xs text-neutral-500 font-geist">{item.duration}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 relative z-10 border-t border-subtle">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            <h2 className="text-5xl md:text-7xl uppercase mb-4 text-white tracking-tighter font-space-grotesk font-light">
              AI Video <span className="text-gradient">Capabilities</span>
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Text-to-Speech', desc: '40+ voices, 20+ languages', icon: '🗣️' },
              { title: 'Auto-Captioning', desc: '98% accuracy, stylized', icon: '📝' },
              { title: 'Background Music', desc: '1,000+ licensed tracks', icon: '🎵' },
              { title: 'Stock Footage', desc: '5M+ clips via Pexels/Unsplash', icon: '🎬' },
              { title: 'Scene Transitions', desc: '50+ cinematic effects', icon: '✨' },
              { title: 'Color Grading', desc: 'Hollywood-style LUTs', icon: '🎨' },
              { title: 'Green Screen', desc: 'AI background removal', icon: '🟢' },
              { title: 'Motion Graphics', desc: 'Animated titles, lower thirds', icon: '📐' }
              ...
              >
                ...
                <h3 className="text-lg font-space-grotesk text-white mb-2">{capability.title}</h3>
                <p className="text-sm text-neutral-400 font-geist">{capability.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 relative z-10 border-t border-subtle bg-gradient-to-b from-black to-purple-950/5">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            <h2 className="text-5xl md:text-7xl uppercase mb-4 text-white tracking-tighter font-space-grotesk font-light">
              See VideoSite.IO <span className="text-gradient">in Action</span>
            </h2>
          </div>
      ...
      <section className="py-24 relative z-10 border-t border-subtle">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            <h2 className="text-5xl md:text-7xl uppercase mb-4 text-white tracking-tighter font-space-grotesk font-light">
              Video Platform <span className="text-gradient">Integrations</span>
            </h2>
          </div>

          <div className="grid grid-cols-3 md:grid-cols-8 gap-6 [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
            {['YouTube', 'Vimeo', 'Wistia', 'Vidyard', 'Loom', 'Zoom', 'Calendly', 'HubSpot'].map((name, index) => (
              <div
                key={index}
      ...
      <section className="border-subtle bg-center z-10 border-t pt-32 pb-32 relative">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <h2 className="md:text-8xl uppercase text-5xl font-light text-white tracking-tighter font-space-grotesk mb-8 [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
            Create Cinematic Videos <span className="text-gradient">in Minutes</span>
          </h2>
          <p className="text-xl text-neutral-400 font-geist mb-10 [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
            Join 5,000+ creators using AI to produce 4K videos
          </p>
