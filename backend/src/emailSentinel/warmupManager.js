...
const FREE_WARMUP_SCHEDULE = [
  ...
  { day: 7, limit: 25 }, { day: 14, limit: 35 }, { day: 21, limit: 45 },
  { day: 30, limit: 50 },
];

const PRO_WARMUP_SCHEDULE = [
  { day: 1, limit: 10 }, { day: 3, limit: 25 }, { day: 5, limit: 50 },
  { day: 7, limit: 80 }, { day: 10, limit: 120 }, { day: 14, limit: 160 },
  { day: 21, limit: 200 },
];

function getScheduleLimit(schedule, day) {
