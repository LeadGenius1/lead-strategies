...
// Shiny animated CTA button component
export default function ShinyButton({ href, children, className = '' }) {
  const ButtonContent = () => (
    <>
      <span className="shiny-btn-span">{children}</span>
    </>
  );
...
// Export the CSS styles to be included in globals.css
export const shinyButtonStyles = `
