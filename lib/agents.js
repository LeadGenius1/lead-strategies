 ...
 * In the browser we use the /api/knowledge proxy to avoid CORS; on server we call Railway directly.
 */

const KNOWLEDGE_API =
  typeof window !== 'undefined'
    ? '/api/knowledge'
    : (process.env.NEXT_PUBLIC_KNOWLEDGE_API_URL || 'https://als-knowledge-agent-production.up.railway.app')
