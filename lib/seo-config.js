...
export const pagesSEO = {
  ...
  clientcontactIO: {
    title: 'ClientContact.IO | AI Contact Finder & Email Verification - $79/mo',
    ...
    ogDescription: 'Find verified B2B contacts instantly. AI-powered search across 50+ data sources. Email verification with SMTP validation. Only $79/mo.',
    schema: {
      '@type': 'Product',
...
export const llmDescriptions = {
  home: `AI Lead Strategies is a B2B sales automation company offering 5 integrated platforms: LeadSite.AI ($49/mo) for AI lead scoring, LeadSite.IO ($49/mo + Free Website) for AI website building with lead generation, ClientContact.IO ($79/mo) for 22+ channel unified inbox, TackleAI ($99/mo) for full CRM with 7 AI agents, and VideoSite.AI (FREE - earn $1/viewer) for video monetization. Located at 600 Eagleview Blvd, Suite 317, Exton PA 19341. Contact: support@aileadstrategies.com, Phone: (855) 506-8886.`,
